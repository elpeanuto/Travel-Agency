...
<fmt:bundle basename="viewBundle">
    ...
    <div class="wrapper">
        ...
        <form method="post" action="registration">
                ...
                <input class="phone_mask" type="text" name="contact" id="contact" placeholder="<fmt:message key="enterPhoneNumber"/>" pattern="\d*" required="required" minlength="10" maxlength="10" />
            <button><fmt:message key="signUp"/></button>
        </form>
